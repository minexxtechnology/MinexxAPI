...
const sendWelcomeEmail = (email, password) => {
  const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
      user: "minexx.dev@gmail.com",
      pass: "osxk qxgj cnuc jczf",
    },
  });
  ...
  transporter.sendMail({
    ...
    subject: "Welcome on board! | Minexx", // Subject line
    text: "Welcome to Minexx Dashboard.\n\nRegards,\n\nMinexx",
    html: `
        ...
        &nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;
        &zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
        &nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;
        </div>
        ...
        <tr data-element="black-intro-5-paragraph" data-label="Intro Paragraph">
            <td data-text-style="Intro Paragraph" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;line-height:32px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                <singleline>
                <div mc:edit data-text-edit>
                    We are excited to have you on board and to introduce you to our Minexx Dashboard. Your new account has been successfully created, and you can now access all the features and tools that will help you.<br><br>
                    To get started, please find your login password below:
                </div>
                </singleline>
            </td>
        </tr>
        ...
        <tr data-element="black-intro-usercode" data-label="User Code">
            ...
            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="580" style="width:580px;max-width:580px;">
                <tr>
                <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="User Code" data-bgcolor="User Code" bgcolor="#000000" style="border-radius: 10px;border: 3px dotted #32a9e1;">
                    <!-- Content -->
                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="580" style="width:580px;max-width:580px;">
                    <tr>
                    ...
                    <tr>
                        <td class="center-text" data-text-style="Use Code" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:32px;line-height:36px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
                            <singleline>
                            <div mc:edit data-text-edit>
        ...
        <tr data-element="black-intro-5-button" data-label="Intro Button">
            ...
            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center">
                <tr>
                <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Intro Button" data-bgcolor="Intro Button" bgcolor="#32a9e1" style="border-radius: 6px;">
            <!--[if (gte mso 9)|(IE)]>
                ...
                <tr>
                    ...
                    <![endif]-->
                    <singleline>
                        <a href="https://dashboard.minexx.co" mc:edit data-button data-text-style="Intro Button" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;line-height:28px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 16px 38px 16px 38px;display: inline-block;"><span>LOGIN NOW</span></a>
                    </singleline>
                    <!--[if (gte mso 9)|(IE)]>
                    </td>
                    <td align="center" width="38"></td>
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;" data-module="black-footer">
            ...
            <td align="center">
                ...
                <tr>
                    ...
                    <multiline>
                        <div mc:edit data-text-edit>
                        2024 Minexx. All Rights Reserved.<br>
